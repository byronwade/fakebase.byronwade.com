...
export { createClient } from "@byronwade/client";
export { createMemoryKernel } from "@byronwade/adapter-memory";

export type { FakebaseClient, FakebaseClientOptions } from "@byronwade/client";
export type {
  FakebaseKernel,
  ProjectSchemaIR,
  TableIR,
...
export type { LocalSession, LocalUser, AuthStateChangeEvent } from "@byronwade/auth";
