 ...
 */
export interface ServerClientOptions<Database = Record<string, Record<string, unknown>>> extends Omit<FakebaseClientOptions<Database>, "kernel"> {
 ...
 * ```
 */
export declare function createServerClient<Database = Record<string, Record<string, unknown>>>(_url: string, _key: string, options: ServerClientOptions<Database>): FakebaseClient<Database>;
/**
 * Options for `createBrowserClient`.
 */
export interface BrowserClientOptions<Database = Record<string, Record<string, unknown>>> extends Omit<FakebaseClientOptions<Database>, "kernel"> {
    /** The kernel backing this client. Required. */
    kernel: FakebaseKernel;
}
/**
 ...
 * ```
 */
export declare function createBrowserClient<Database = Record<string, Record<string, unknown>>>(_url: string, _key: string, options: BrowserClientOptions<Database>): FakebaseClient<Database>;
