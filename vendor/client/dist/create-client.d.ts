...
import { type Channel, type RealtimeClientFacade } from "./realtime-client.js";
 ...
 */
export interface FakebaseClientOptions<Database = Record<string, Record<string, unknown>>> {
    /**
 ...
 */
export interface FakebaseClient<Database = Record<string, Record<string, unknown>>, SchemaName extends string = "public"> {
    /**
     ...
     */
    from<TableName extends string>(table: TableName): DatabaseBuilder<Database, SchemaName, TableName>;
    /**
    ...
    schema<S extends string>(schemaName: S): {
        from<TableName extends string>(table: TableName): DatabaseBuilder<Database, S, TableName>;
    };
 ...
 * ```
 */
export declare function createClient<Database = Record<string, Record<string, unknown>>, SchemaName extends string = "public">(_url: string, _key: string, options: FakebaseClientOptions<Database>): FakebaseClient<Database, SchemaName>;
