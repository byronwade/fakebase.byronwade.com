    ...
    switch (filter.operator) {
        ...
        case "contains": {
            ...
            if (Array.isArray(col) && Array.isArray(val)) {
                return val.every((v) => col.includes(v));
            }
            if (typeof val === "object" && val !== null && !Array.isArray(val)) {
                return Object.entries(val).every(([k, v]) => col[k] === v);
            }
            return false;
        }
        case "containedBy": {
            ...
            if (Array.isArray(col) && Array.isArray(val)) {
                return col.every((v) => val.includes(v));
            }
            return false;
        }
        case "overlaps": {
            ...
            if (Array.isArray(col) && Array.isArray(val)) {
                return col.some((v) => val.includes(v));
            }
            return false;
        }
        case "rangeGt": {
        ...
        case "match": {
            ...
            if (typeof col !== "string" || typeof val !== "string")
                return false;
...
export function parseOrString(str) {
    const filters = str.split(",").map((part) => {
