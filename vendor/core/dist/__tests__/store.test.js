...
describe("FakeStore", () => {
    ...
    describe("insert", () => {
        ...
        it("throws on duplicate primary key", () => {
            ...
            expect(() => store.insert("public", "users", {
                id: "1",
                name: "Alice2",
        ...
        it("throws for unknown table", () => {
            expect(() => store.insert("public", "nonexistent", { id: "1" })).toThrowError(FakebaseError);
        });
    });
    describe("getByPk", () => {
    ...
    describe("update", () => {
        ...
        it("throws for non-existent row", () => {
            expect(() => store.update("public", "users", "999", { name: "X" })).toThrowError(FakebaseError);
        });
    });
    describe("delete", () => {
