 ...
 * of the floating dock). Collapsed it's a dark `--dock`-toned pill (the Fakebase
 * mark + an app-switcher grid). The pill **morphs in place** into a browse panel:
 * the cross-product switcher with the theme toggle + GitHub link in the footer.
 */
